...
export function PillButton({
  ...
  return (
    <a
      href={href}
      className={`group inline-flex h-[58px] items-center justify-between gap-3 rounded-full bg-ink pl-7 pr-2 font-semibold text-white transition-colors hover:bg-ink-2 ${className}`}
    >
